...
export class SchoolsComponent implements OnInit {
  schools = [
    { id: 1, name: 'Irle Elementary School' },
    { id: 2, name: 'Glasgow Middle School' },
    { id: 3, name: 'Glasgow High School' },
  ];
  ...
  ngOnInit(): void {
    ...
    loader.load().then(() => {
      ...
      const hotelPoints: [google.maps.LatLngLiteral, string][] = [
        [{ lat: 48.20467849639556, lng: -106.63655666286449 }, 'Irle Elementary School'],
        [{ lat: 48.195923519621694, lng: -106.61867394858558 }, 'Glasgow Middle School'],
        [{ lat: 48.203771126448274, lng: -106.61324282323037 }, 'Glasgow High School', ],
      ];
